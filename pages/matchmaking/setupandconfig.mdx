...
Updated Example at : https://docs.edgegap.com/learn/matchmaking/getting-started-with-gen2/#simple-example
...
- `name` and `version` are the name and version of your application that will be used to identify the server to be used for the match. More information can be found [here](https://docs.edgegap.com/docs/gen2-matchmaker/#matchmaking-profiles).
